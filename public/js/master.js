(function() {
  $(function(){;
  var c_height, c_width, enableNext, get_dimensions, next_photo, photos, pos, prev_photo, resizeAll, resizeImg, resizePhoto, revealPhoto, transforms_unsupporteds, update_pos, update_position, x;
